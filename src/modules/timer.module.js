...
export class CountdownTimer extends Module {
    trigger() {
            ...
            !document.getElementById("timer"))
        {
            ...
            this.$rootElement.classList.add('nocopy');
            this.$rootElement.id = "timer-form";

            this.$timerFormInputLabel = document.createElement("label");
            this.$timerFormInputLabel.className = "timer-form__input-label";
            this.$timerFormInputLabel.innerText = "Задайте время до окончания таймера, мин : сек   ";

            this.$timerFormMinutesInput = document.createElement("input");
            this.$timerFormMinutesInput.className = "timer-form__minute-input";
            ...
            this.$timerFormSecondsInput = document.createElement("input");
            this.$timerFormSecondsInput.className = "timer-form__minute-input";
            ...
            this.$timerFormSubmitButton = document.createElement("button");
            this.$timerFormSubmitButton.disabled = true;
            this.$timerFormSubmitButton.className = "timer-form__submit-button";
            this.$timerFormSubmitButton.type = "submit";
            this.$timerFormSubmitButton.innerText = "Задать";

            this.$timerFormInputLabel.appendChild(this.$timerFormMinutesInput);
            this.$timerFormInputLabel.appendChild(this.$timerFormSecondsInput);

            this.$rootElement.appendChild(this.$timerFormInputLabel);

            this.$timerFormInputLabel.appendChild(this.$timerFormSubmitButton);
        ...
        this.$inputSeconds.addEventListener("input", this.handleInput.bind(this));
        this.$inputMinutes.addEventListener("input", this.handleInput.bind(this));
    ...
    countTimer(count) {
        ...
        this.$timerElement.classList.add('nocopy');
